...
public class Config {
// Thông tin cấu hình kết nối VNPAY (URL sandbox, mã cửa hàng, khóa bí

    public static String vnp_PayUrl = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
    public static String vnp_ReturnUrl = "http://localhost:8080/DIY_Main/vnpay_return";
...
// Tạo chuỗi hash cho tất cả trường (sử dụng trong kiểm tra callback VNPAY
